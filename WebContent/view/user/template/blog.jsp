...
<title>The Online Book Stor</title>
						...
						<c:forEach items="${boardnewlist}" var="lasted">
							<div class="col-lg-6 col-sm-6">
								<div class="blog-item">
									<div class="bi-pic">
										<img
											src="${pageContext.request.contextPath}/${lasted.urlTemp}"
											alt=""
											style="width: 110px; height: 390px; object-fit: cover; border: 1px solid #fff;">
